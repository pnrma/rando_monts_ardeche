 ...
 * the page itself.
 */
export declare const initPageEvents: (page: IonicPage) => Promise<void>;
/**
 * Adds a new event listener in the current
 * page context to updates the _e2eEvents map
 * when an event is fired.
 */
export declare const addE2EListener: (page: IonicPage, eventName: string, callback: (ev: any) => void) => Promise<void>;
